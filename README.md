 ...
 **Database insertion:**
   ...
   To insert the datadrame into MySQL first I've created a new database and tables using **"mysql-connector-python"** library in Python to connect to a MySQL database and insert the transformed data using SQL commands.
   ...
   **Creating tables**
       ...
       create_query_1 = '''CREATE TABLE IF NOT EXISTS Table name(col1 varchar(100), col2 int, col3 int, col4 varchar(100), col5 int, col6 double)'''
       mycursor.execute(create_query_1)
       mydb.commit()

       insert_query_1 = '''INSERT INTO Table name(col1, col2, col3, col4, col5, col6) VALUES(%s,%s,%s,%s,%s,%s)'''
